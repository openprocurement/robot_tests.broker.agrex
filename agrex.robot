...
Підготувати клієнт для користувача
  ...
  Run Keyword If   '${ARGUMENTS[0]}' != 'agrex_Viewer'   Login   ${ARGUMENTS[0]}
...
Завантажити документ
  ...
  ...      ${ARGUMENTS[2]} ==  ${TENDER}
  agrex.Пошук тендера по ідентифікатору   ${ARGUMENTS[0]}   ${ARGUMENTS[2]}
...
Скасувати закупівлю
  ...
  agrex.Пошук тендера по ідентифікатору    ${ARGUMENTS[0]}    ${ARGUMENTS[1]}
...
Отримати інформацію із предмету
  ...
  ${return_value}=  Run Keyword And Return  agrex.Отримати інформацію із тендера  ${username}  ${tender_uaid}  ${field_name}
  [return]           ${return_value}
...
Отримати інформацію про dgfDecisionDate
  ...
  ${return_value}=   agrex_service.convert_date    ${date_value}
  [return]           ${return_value}
...
Отримати інформацію із пропозиції
  ...
  agrex.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
  Wait Until Page Contains Element   xpath=(//*[@id='btnShowBid' and not(contains(@style,'display: none'))])
  Click Element       id=btnShowBid
  Sleep   3
...
Додати предмет закупівлі
  ...
  agrex.Пошук тендера по ідентифікатору   ${username}   ${tender_uaid}
  ${index}=  agrex.Отримати кількість предметів в тендері     ${username}   ${tender_uaid}
...
Підтвердити підписання контракту
  ...
  Sleep    5
  agrex.Завантажити угоду до тендера   ${username}  ${tender_uaid}  1  ${filepath}
  Wait Until Page Contains Element      xpath=(//*[@id='tPosition_status' and not(contains(@style,'display: none'))])
